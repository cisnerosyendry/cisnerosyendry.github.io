...
class ImageTicketModel
{
                    ...
                    if (!file_exists($this->upload_path . $fileName)) {
                        ...
                        if ($fileSize < 2000000 && $fileError == 0) {
                            ...
                            if (move_uploaded_file($tempPath, $this->upload_path . $fileName)) {
                                //Guardarlo en la BD
                                $sql = "INSERT INTO imagen_ticket (id_imagen,image) VALUES ($id_imagen, '$fileName')";
    ...
    //Obtener una imagen de un ticket
    public function getImageTicket($id_imagen)
    {
        try {
            
            //Consulta sql
            $vSql = "SELECT * FROM imagen_ticket where id_imagen=$id_imagen";
